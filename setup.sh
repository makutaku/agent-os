...
BASE_URL="https://raw.githubusercontent.com/makutaku/agent-os/main"
...
echo "     curl -sSL https://raw.githubusercontent.com/makutaku/agent-os/main/setup-claude-code.sh | bash"
echo ""
echo "   - Using Cursor? Install the Cursor commands with:"
echo "     curl -sSL https://raw.githubusercontent.com/makutaku/agent-os/main/setup-cursor.sh | bash"
echo ""
